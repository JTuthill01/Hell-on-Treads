...
Player::Player()
{
	...
	this->mPlayerSprite.setOrigin(this->mPlayerSprite.getGlobalBounds().left + this->mPlayerSprite.getGlobalBounds().width / 2,
		this->mPlayerSprite.getGlobalBounds().top + this->mPlayerSprite.getGlobalBounds().height / 2);
...
void Player::initVariables()
{
	...
	this->mKeyTimeMax = 35.5F;

	this->mKeyTime = mKeyTimeMax;

	this->mIsContact = false;

	this->mShootTimerMax = 35.F;
